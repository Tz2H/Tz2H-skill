#!/usr/bin/env python3
"""
Character preset registry for the Tz2H-skill engine.
...
CHARACTER_PRESETS = {
    "colleague": {
        ...
        "prompt_bundle": {
            "preset": "tz2h.colleague.v1",
            "intake": "prompts/colleague/intake.md",
            "work_analyzer": "prompts/colleague/work_analyzer.md",
            "persona_analyzer": "prompts/colleague/persona_analyzer.md",
            "work_builder": "prompts/colleague/work_builder.md",
            "persona_builder": "prompts/colleague/persona_builder.md",
            "merger": "prompts/colleague/merger.md",
