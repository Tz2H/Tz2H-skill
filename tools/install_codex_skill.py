#!/usr/bin/env python3
"""Install the current Tz2H-skill repo into the local Codex skill directory."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Install Tz2H-skill into Codex")
    parser.add_argument(
        "--source",
    ...
    parser.add_argument(
        "--dest",
        default=str(Path.home() / ".codex" / "skills" / "Tz2H-skill"),
