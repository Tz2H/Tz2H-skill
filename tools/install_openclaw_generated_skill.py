#!/usr/bin/env python3
"""Install a generated Tz2H-skill artifact into OpenClaw discovery paths."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Install a generated Tz2H-skill into OpenClaw")
